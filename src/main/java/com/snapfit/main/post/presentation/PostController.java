...
public class PostController {
    ...
    public Mono<ResponseEntity<PageResult<PostSummaryDto>>> getLikePosts(Authentication authentication, @RequestParam("limit") int limit, @RequestParam("offset") int offset) {
